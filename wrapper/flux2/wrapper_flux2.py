"""
Wrapper class for FLUX.2-dev image generation using Hugging Face Diffusers and Xfuser.
"""
import logging
import sys
import random
...
class Flux2Generation(FluxGeneration):
    """Wrapper class for FLUX.2-dev image generation using Hugging Face Diffusers and Xfuser."""

    HF_MODEL_NAME = "black-forest-labs/FLUX.2-dev"
    ...
    def load_model(self) -> None:
        ...
        logging.info(
            "Loaded Flux2Pipeline: %s device:%s dtype:%s.",
    ...
    async def generate(
        ...
        """Generate an image from a prompt using the FLUX.2-dev model.
