# mypy: ignore-errors
# Copy from https://github.com/microsoft/VibeVoice/blob/main/vibevoice/modular/modular_vibevoice_text_tokenizer.py
...
class VibeVoiceTextTokenizerFast(Qwen2Tokenizer):
    """
