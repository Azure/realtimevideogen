...
class DPMSolverMultistepScheduler(SchedulerMixin, ConfigMixin):
    ...
    def __init__(
        ...
        if algorithm_type in ["dpmsolver", "sde-dpmsolver"]:
            deprecation_message = (
                f"algorithm_type {algorithm_type} is deprecated and will be removed "
                "in a future version. Choose from `dpmsolver++` or `sde-dpmsolver++` instead"
            )
        ...
        **kwargs: Any,
        ...
        if timestep is not None:
            deprecate(
                "timesteps",
                "1.0.0",
                "Passing `timesteps` is deprecated and has no effect as model output conversion is now handled via "
        ...
        **kwargs: Any,
        ...
        if prev_timestep is not None:
            deprecate(
                "prev_timestep",
                "1.0.0",
                "Passing `prev_timestep` is deprecated and has no effect as model output conversion is now handled "
        ...
        **kwargs: Any,
        ...
        if timestep_list is not None:
            deprecate(
                "timestep_list",
                "1.0.0",
                "Passing `timestep_list` is deprecated and has no effect as model output conversion is now handled "
                "via an internal counter `self.step_index`",
            )
